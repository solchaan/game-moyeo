  ...
  return <div className="lobby-page">
    ...
    <div className="lobby-shell">
      <aside className="lobby-library" aria-labelledby="game-library-title">
        <div className="lobby-library-head"><span className="lobby-kicker" id="game-library-title">PICK YOUR GAME</span></div>
      ...
      <div className="lobby-main">
        <div className="lobby-intro">
          <div><p className="lobby-kicker"><span aria-hidden="true">✳</span> THE PLAYER'S LOBBY</p><p className="lobby-intro-description">게임을 고르고, 마음 맞는 모임에 합류하세요.</p></div>
        ...
        <section className="lobby-board" id="party-board" aria-labelledby="party-board-title" tabIndex={-1}>
          <div className="lobby-board-head"><div><span className="lobby-board-index" aria-hidden="true">01 /</span><h1 id="party-board-title">{selectedGame?.name ?? (gameId ? '선택한 게임' : '전체 모임')}</h1></div><span className="lobby-board-caption">함께할 플레이어를 찾는 곳</span></div>
